...
itemCodes = document.getElementsByClassName('bundleSKU')
itemNames = document.getElementsByClassName('bundleName')
...
function filterItemList(){
    ...
    for (i = 0; i < itemCodes.length; i++){
       ...
       console.log(textInput + ' : '+itemCodes[i].innerText + ' : Result - ' + codeResult)
       console.log(textInput + ' : '+itemNames[i].innerText + ' : Result - ' + nameResult)

       let eleName = 'bundle_' + itemCodes[i].getAttribute("name")
       ...
       if (nameResult != null || codeResult != null){
           ...
           itemEle = document.getElementById('bundle_'+ itemCodes[i].getAttribute("name"))
           console.log(itemEle)
